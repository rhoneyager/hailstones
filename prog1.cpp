...
int main(int argc, char** argv) {
	...
	try {
		...
		struct analysis_data {
			...
			double actual_bounds[6], mesh_bounds[6], actual_bound_volume_cm3, mesh_bound_volume_cm3;
			...
			static void writeHeader(std::ostream &out) {
				out << "ID,contouredVol_cm3,contouredMass_g,discretized_volume_cm3,"
					...
					"mesh_bound_volume_cm3,vf_contoured_boxed,resolution_mm,aeff_um,"
			...
			void write(std::ostream &out) {
				out << sFileId << "," << contouredVol_cm3 << "," << contouredMass_g << "," << discretized_volume_cm3 << ","
					...
					<< mesh_bound_volume_cm3 << "," << vf_contoured_boxed << "," << resolution_mm << ","
